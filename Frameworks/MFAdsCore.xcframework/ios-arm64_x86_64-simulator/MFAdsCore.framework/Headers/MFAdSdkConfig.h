...
#import <MFAdsCore/MFConfigModel.h>

NS_ASSUME_NONNULL_BEGIN

typedef NS_ENUM(NSInteger,MFAdLogLevel) {
    MFAdLogLevel_None  = 0, // 不打印
    MFAdLogLevel_Fatal,
    MFAdLogLevel_Error,
    MFAdLogLevel_Warning,
    MFAdLogLevel_Info,
    MFAdLogLevel_Debug,
};
...
extern NSString *const MFAdSdkTypeAdName;
extern NSString *const MFAdSdkTypeAdNameSplash;
extern NSString *const MFAdSdkTypeAdNameBanner;
extern NSString *const MFAdSdkTypeAdNameInterstitial;
extern NSString *const MFAdSdkTypeAdNameFullScreenVideo;
extern NSString *const MFAdSdkTypeAdNameNativeExpress;
extern NSString *const MFAdSdkTypeAdNameRewardVideo;
...
#define  K_TabbarSafeBottomMargin       (kIsSafeArea ? 34.f : 0.f)
...
@interface MFAdSdkConfig : NSObject
...
- (void)registerAppID:(NSString *)appID
           withConfig:(MFConfigModel * __nullable)config;
...
/// 5 全部打印
@property (nonatomic, assign) MFAdLogLevel level;
