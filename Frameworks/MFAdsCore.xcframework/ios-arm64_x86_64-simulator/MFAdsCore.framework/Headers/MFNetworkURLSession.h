...
typedef void (^MFNetworkCompletionHandler)(NSHTTPURLResponse *_Nullable response,
                                            NSDictionary *_Nullable data,
                                            NSError *_Nullable error);
typedef void (^MFNetworkURLSessionCompletionHandler)(NSHTTPURLResponse *_Nullable response,
                                                      NSData *_Nullable data,
                                                      NSString *sessionID,
                                                      NSError *_Nullable error);
typedef void (^MFNetworkSystemCompletionHandler)(void);

@interface MFNetworkURLSession : NSObject
...
@property(nonatomic, weak, nullable) id<MFNetworkLoggerProtocol> loggerDelegate;
...
- (instancetype)initWithNetworkLoggerDelegate:
    (nullable id<MFNetworkLoggerProtocol>)networkLoggerDelegate NS_DESIGNATED_INITIALIZER;
...
- (nullable NSString *)sessionIDFromAsyncPOSTRequest:(NSURLRequest *)request
                                   completionHandler:(MFNetworkURLSessionCompletionHandler)handler;
